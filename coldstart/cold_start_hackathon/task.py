...
class Net(nn.Module):
    """EfficientNet B0 model for binary chest X-ray classification."""
    ...
    def __init__(self):
        ...
        # Adapt first conv layer to grayscale input (1 channel instead of 3)
        # EfficientNet uses 'features[0][0]' for the first conv layer
        ...
        # Replace classifier for binary classification (single logit)
